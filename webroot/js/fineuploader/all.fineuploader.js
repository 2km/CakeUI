...
!function() {
    ...
    qq.basePublicApi = {
        ...
        _handleNewFile: function(a, b) {
            var c = this, d = qq.getUniqueId(), e =- 1, f = qq.getFilename(a), g = a.blob || a, h = this._customNewFileHandler ? this._customNewFileHandler : qq.bind(c._handleNewFileGeneric, c);
        ...
        }, _onSubmit: function() {}, _onProgress: function(a, b, c, d) {
        ...
        }, _onUploadPrep: function() {}, _onUpload: function(a) {
    ...
    function i(a) {
        var b, d = qq.indexOf(p, a), e = m.maxConnections;
    ...
    function k() {
        var a = b ? qq[b]: qq, c = qq.supportedFeatures.ajaxUploading ? "Xhr": "Form";
    ...
    m = {
        ...
        retry: function(a) {
            var b = qq.indexOf(p, a), d = c(a), e = d && d instanceof qq.BlobProxy;
    ...
    "use strict";
    function b(a) {
        var b = f[a].xhr, c = f[a].currentAjaxRequester;
        b.onreadystatechange = null, b.upload.onprogress = null, b.abort(), c && c.canceled && c.canceled(a)
    }
    var c = this, d = a.options, e = a.proxy, f = {}, g = d.chunking, h = e.onUpload, i = e.onCancel, j = e.getName, k = e.getSize, l = e.log;
    qq.extend(this, {
        add: function(a, b) {
            if (qq.isFile(b) || qq.isBlob(b))
                f[a] = {
                    file: b
                };
            else {
                if (!(b instanceof qq.BlobProxy))
        ...
        _getChunkData: function(a, b) {
            var d = g.partSize, e = k(a), f = c.getFile(a), h = d * b, i = h + d >= e ? e: h + d, j = this._getTotalChunks(a);
            return {
                part: b,
                start: h,
                end: i,
    ...
    function b() {
        ...
        if (b = qq.trimStr(b), d = document.createElement("div")
            , d.appendChild(qq.toElement(b)), P.button && (f = qq(d).getByClass(Q.button)[0], f && qq(f).remove()), qq.DragAndDrop && qq.supportedFeatures.fileDrop || (i = qq(d).getByClass(Q.dropProcessing)[0], i && qq(i).remove()), g = qq(d).getByClass(Q.drop)[0], g&&!qq.DragAndDrop && (A("DnD module unavailable.", "info"), qq(g).remove()), g&&!qq.supportedFeatures.fileDrop && qq(g).hasAttribute(M) && qq(g).css({
            display: "none"
    ...
    function f(b, c, d, e) {
        var f = new FormData, g = a.demoMode ? "GET": "POST", h = a.endpointStore.get(e), i = h, j = I(e), k = K(e);
    ...
    function g(b, c) {
        var d = a.customHeaders, e = R.getFile(b);
    ...
    function i(b) {
        var c, h, i = R._getFileState(b).remainingChunkIdxs[0], k = R._getChunkData(b, i), l = R._createXhr(b), m = K(b), n = I(b);
        void 0 === R._getFileState(b).loaded && (R._getFileState(b).loaded = 0), P && R.getFile(b) && t(b, k), l.onreadystatechange = s(b, l), l.upload.onprogress = function(c) {
            if (c.lengthComputable) {
                var d = c.loaded + R._getFileState(b).loaded, e = j(b, i, c.total);
    ...
    function j(a, b, c) {
        var d = R._getChunkData(a, b), e = d.size, f = c - e, g = K(a), h = d.count, i = R._getFileState(a).initialRequestOverhead, j = f - i;
    ...
    function l(b, c, d) {
        var e = R._getFileState(b).remainingChunkIdxs.shift(), f = R._getChunkData(b, e);
    ...
    function r(a, b) {
        var c, d = R._getFileState(a), e = d && d.attemptingResume, f = d && d.paused;
    ...
    function t(b, c) {
        if (R.isResumable(b)) {
            var d = J(b), e = R._getFileState(b).loaded, f = R._getFileState(b).initialRequestOverhead, g = R._getFileState(b).estTotalRequestsSize, h = w(b), i = d + N + c.part + N + e + N + f + N + g, j = a.resume.cookiesExpireIn;
            qq.setCookie(h, i, j)
        }
    }
    function u(a) {
    ...
    function v(a) {
        var b, c, d, e, f, g, h = qq.getCookie(w(a)), i = I(a);
        if (h) {
            if (b = h.split(N), 5 === b.length)
    ...
    function w(b) {
        var c, d = I(b), e = K(b), f = a.chunking.partSize;
        return c = "qqfilechunk" + N + encodeURIComponent(d) + N + e + N + f, void 0 !== F && (c += N + F), c
    }
    function x(a, b) {
        var c;
        for (c = R._getTotalChunks(a)-1; c >= b; c -= 1)
            R._getFileState(a).remainingChunkIdxs.unshift(c);
        i(a)
    }
    function y(a, b, c, d) {
    ...
    function z(b, c, d) {
        var e, f = I(b), g = R._getChunkData(b, c.part);
    ...
    var F, G = b.onUploadComplete, H = b.onUuidChanged, I = b.getName, J = b.getUuid, K = b.getSize, L = b.getDataByUuid, M = b.log, N = "|", O = a.chunking.enabled && qq.supportedFeatures.chunking, P = a.resume.enabled && O && qq.supportedFeatures.resume, Q = a.forceMultipart || a.paramsInBody, R = this;
        ...
        return {
            ...
            getResumableFilesData: function() {
                ...
                return O && P ? (b = void 0 === F ? qq.getCookieNames(new RegExp("^qqfilechunk\\" + N + ".+\\" + N + "\\d+\\" + N + a.chunking.partSize + "=")) : qq.getCookieNames(new RegExp("^qqfilechunk\\" + N + ".+\\" + N + "\\d+\\" + N + a.chunking.partSize + "\\" + N + F + "=")), qq.each(b, function(a, b) {
                    var d = b.split(N), e = qq.getCookie(b).split(N);
                    c.push({
    ...
    function c(a) {
        ...
        return a.isFile ? a.file(function(b) {
            var c = a.name, e = a.fullPath, f = e.indexOf(c);
    ...
    function h() {
        var a = i.dropZoneElements, b = function() {
            setTimeout(function() {
    ...
    qq.extend(this, {
        ...
        handleNewFile: function(a, b, c, d, e, f, g) {
            var h = this, i = (a.qqButtonId || a.blob && a.blob.qqButtonId, []), j = null, k = g.addFileToHandler, l = g.uploadData, m = g.paramsStore;
...
qq.TotalProgress = function(a, b) {
    ...
    var c = {}, d = 0, e = 0, f = function(a, b) {
        ...
        var h = c[b] ? c[b].loaded: 0, i = c[b] ? c[b].total: 0;
        -1 === f&&-1 === g ? (d -= h, e -= i) : (f && (d += f - h), g && (e += g - i)), a(d, e)
    };
    qq.extend(this, {
        onAllComplete: h,
    ...
    "use strict";
    var b = this, c = a.options, d = a.proxy, e = c.chunking, f = c.resume, g = c.namespace, h = d.onUuidChanged, i = c.resumeEnabled, j = d.getEndpoint, k = d.getName, l = d.getSize, m = d.getUuid, n = d.getDataByUuid, o = d.log, p = new qq.AbstractUploadHandlerXhr(a);
    qq.extend(this, p), qq.extend(this, {
        ...
        _maybePersistChunkedState: function(a) {
            ...
            i && b.isResumable(a) && (c = b._getLocalStorageId(a), d = {
                name : k(a), size: l(a), uuid: m(a), key: e.key, loaded: e.loaded, chunking: e.chunking, lastUpdated: Date.now()
            },
        ...
        _getLocalStorageId: function(a) {
            var b = k(a), c = l(a), d = e.partSize, f = j(a);
    ...
    qq.extend(k, a, !0), h = k.signatureSpec.credentialsProvider, g = qq.extend(this, new qq.AjaxRequester({
        ...
        getSignature: function(a, b) {
            ...
            g.initTransport(a).withParams(c).send(),
            j[a] = {
                promise: e
            }), e
    ...
    function c(b, c) {
        ...
        try {
            ...
            if (g.bucket === e && g.key === qq.s3.util.encodeQueryStringParam(h._getFileState(b).key))
                return !0;
    ...
    function e(b, c) {
        var e = new qq.Promise, f = a.demoMode ? "GET": "POST", i = a.endpointStore.get(b), j = k(b);
    ...
    function f(a) {
        var b = k(a), d = h._createIframe(a), f = h._getFileState(a).input;
    ...
    qq.extend(this, new qq.AbstractUploadHandlerForm({
        ...
        upload: function(a) {
            var b = h._getFileState(a).input, c = k(a);
            if (!b)
                throw new Error("file with passed id was not added, or already uploaded or canceled");
    ...
    function i(b, c, d) {
        var e = d || T._getFileState(b).xhr, f = z(b), g = B(b), i = j(b, d), k = c || j(b), l = T._getFileState(b).paused, m=!l && (null != c || i.success!==!0);
    ...
    function j(a, b) {
        var c, d = b || T._getFileState(a).xhr, e = {};
        try {
    ...
    function m(a) {
        var b = T._getFileState(a).xhr, c = z(a), d = T.getFile(a);
    ...
    function o(a, b) {
        var c = new FormData, d = L.get(a), e = d, f = T._getFileState(a).xhr, g = new qq.Promise;
    ...
    function r(a) {
        var b = T._getFileState(a).chunking.parts, c = q(a);
        b > c ? t(a) : s(a)
    }
    function s(a) {
        var b = T._getFileState(a).chunking.uploadId, c = T._getFileState(a).chunking.etags;
    ...
    function t(b) {
        var c = q(b), d = z(b), e = T._getFileState(b).xhr, f = B(b), h = T._getChunkData(b, c), j = a.endpointStore.get(b);
    ...
    function u(b) {
        var d = {}, e = a.endpointStore.get(b), f = qq.s3.util.getBucket(e), g = c(b), h = new qq.Promise, i = W.constructStringToSign(W.REQUEST_TYPE.MULTIPART_UPLOAD, f, g).withPartNum(q(b) + 1).withUploadId(T._getFileState(b).chunking.uploadId);
    ...
    function w(b) {
        var c, d = q(b), e = T._getFileState(b).xhr, f = j(b), g = T._getChunkData(b, d);
    ...
    var x = b.onUploadComplete, y = b.onUuidChanged, z = b.getName, A = b.getUuid, B = b.getSize, C = b.getDataByUuid, D = b.log, E = 200, F = a.onProgress, G = a.onComplete, H = a.onUpload, I = a.getKeyName, J = a.filenameParam, K = a.paramsStore, L = a.endpointStore, M = a.aclStore, N = a.objectProperties.reducedRedundancy, O = a.objectProperties.serverSideEncryption, P = a.validation, Q = a.signature, R = a.chunking.enabled && qq.supportedFeatures.chunking, S = a.resume.enabled && R && qq.supportedFeatures.resume && void 0 !== window.localStorage, T = this, U = a.signature.credentialsProvider, V = new qq.s3.RequestSigner({
        expectingPolicy: !0,
        signatureSpec: Q,
        cors: a.cors,
        log: D
    ...
    qq.extend(this, new qq.AbstractNonTraditionalUploadHandlerXhr({
        ...
        return {
            expunge: function(b) {
                var c = T._getFileState(b).chunking && T._getFileState(b).chunking.uploadId, d = T._maybeDeletePersistedChunkData(b);
                void 0 !== c && d && Z.send(b, c), a.expunge(b)
            },
            _getLocalStorageId: function(b) {
                var c = a._getLocalStorageId(b), d = L.get(b), e = qq.s3.util.getBucket(d);
                return c + "-" + e
            }
        }
    })
    ...
    "use strict";
    function c(a) {
        var b = o.get(a), c = new qq.Promise, d = function(d) {
    ...
    function h(a) {
        var b = k._getFileState(a).chunking.parts, c = g(a);
        k.isValid(a) && b > c ? i(a, c) : j(a)
    }
    function i(a, b) {
        e(a, function(c) {
            var d = k._getChunkData(a, b), e = M.upload(a, c, b, d.blob);
            k._registerXhr(a, e, M)
        })
    }
    function j(a) {
        e(a, function(b) {
            var c = k._getMimeType(a), d = k._getFileState(a).chunking.blockIds, e = N.send(a, b, d, c);
            k._registerXhr(a, e, N)
        })
    }
    var k = this, l = b.log, m = a.cors, n = b.onUploadComplete, o = a.endpointStore, p = a.paramsStore, q = a.signature, r = a.filenameParam, s = a.chunking.minFileSize, t = a.chunking.enabled && qq.supportedFeatures.chunking, u = a.deleteBlob, v = a.resume.enabled && t && qq.supportedFeatures.resume && void 0 !== window.localStorage, w = a.onGetBlobName, x = a.onProgress, y = a.onComplete, z = a.onUpload, A = a.onUploadChunk, B = a.onUploadChunkSuccess, C = b.onUuidChanged, D = function(a) {
        var b = p.get(a);
        return b[r] = G(a), b
    }, E = function(a) {
        ...
        onProgress: K,
        onUpload: function(a) {
            var b = g(a), c = k._getChunkData(a, b);
            A(a, G(a), k._getChunkDataForCallback(c))
        },
        onComplete: function(a, b, c, d) {
            var e = g(a), f = k._getChunkData(a, e), i = k._getChunkDataForCallback(f);
    ...
    qq.extend(this, new qq.AbstractNonTraditionalUploadHandlerXhr({
        ...
        return {
            expunge: function(b) {
                var c = k._getFileState(b).canceled, d = k._getFileState(b).chunking, e = d && d.blockIds || [];
    ...
    qq.extend(d, a), b = qq.extend(this, new qq.AjaxRequester({
        ...
        cors: {
            expected: !0
        }, log : d.log, onSend : d.onDelete, onComplete : d.onDeleteComplete
    })), qq.extend(this, {
        method: c,
        send: function(a) {
    ...
    qq.extend(d, a), b = qq.extend(this, new qq.AjaxRequester({
        ...
        customHeaders: function(a) {
            ...
            return c["x-ms-blob-type"] = "BlockBlob",
            c
        }, endpointStore : f, allowXRequestedWithAndCacheControl : !1, cors : {
            expected : !0
        }, log : d.log, onSend : d.onUpload, onComplete : function(a) {
    ...
    function b(a) {
        ...
        return qq.each(a, function(a, c) {
            var d = b.createElement("Latest"), e = b.createTextNode(c);
    ...
    qq.extend(f, a), c = qq.extend(this, new qq.AjaxRequester({
        ...
        }, contentType : "text/plain", endpointStore : h, allowXRequestedWithAndCacheControl : !1, cors : {
            expected : !0
        }, log : f.log, onSend : function() {}, onComplete : function(a) {
    ...
    qq.extend(f, a), c = qq.extend(this, new qq.AjaxRequester({
        ...
        cors: {
            expected: !0
        }, log : f.log, onSend : f.onUpload, onComplete : function(a, b, c) {
...
!function() {
    ...
    d.Base64 = {
        stringify: function(a) {
            ...
            for (var e = [], f = 0; c > f; f += 3)
                for (var g = 255 & b[f>>>2]>>>24-8 * (f%4), h = 255 & b[f + 1>>>2]>>>24-8 * ((f + 1)
                    %4), i = 255 & b[f + 2>>>2]>>>24-8 * ((f + 2)%4), j = g<<16 | h<<8 | i, k = 0;
            4 > k && c > f + .75 * k;
            k++)e.push(d.charAt(63 & j>>>6 * (3 - k)));
            var l = d.charAt(64);
            if (l)
                for (; e.length%4;)
                    e.push(l);
    ...
    var a = CryptoJS, b = a.lib, c = b.WordArray, d = b.Hasher, e = a.algo, f = [], g = e.SHA1 = d.extend({
        _doReset: function() {
